...
# Rimozione delle righe dove almeno un elemento è mancante/nullo
...
# alternativa funzionante alla sostituzione dati mancanti -> versione usare correntemente ora da ultimi aggiornamenti
